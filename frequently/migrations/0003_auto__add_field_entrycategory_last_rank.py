...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryCategory.last_rank'
        db.add_column('frequently_entrycategory', 'last_rank',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryCategory.last_rank'
        db.delete_column('frequently_entrycategory', 'last_rank')
