...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.submitted_by'
        db.add_column(u'frequently_entry', 'submitted_by',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.submitted_by'
        db.delete_column(u'frequently_entry', 'submitted_by')
    ...
    models = {
        ...
        u'frequently.entry': {
            ...
            'submitted_by': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
