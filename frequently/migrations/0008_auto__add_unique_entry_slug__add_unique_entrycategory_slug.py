...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('frequently_entry', ['slug'])

        # Adding unique constraint on 'EntryCategory', fields ['slug']
        db.create_unique('frequently_entrycategory', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'EntryCategory', fields ['slug']
        db.delete_unique('frequently_entrycategory', ['slug'])

        # Removing unique constraint on 'Entry', fields ['slug']
        db.delete_unique('frequently_entry', ['slug'])
