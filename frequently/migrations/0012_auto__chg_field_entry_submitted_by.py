...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entry.submitted_by'
        db.alter_column(u'frequently_entry', 'submitted_by', self.gf('django.db.models.fields.EmailField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Entry.submitted_by'
        db.alter_column(u'frequently_entry', 'submitted_by', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        u'frequently.entry': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
        ...
        u'frequently.feedback': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 29, 0, 0)'}),
