...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntryCategory.fixed_position'
        db.add_column('frequently_entrycategory', 'fixed_position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntryCategory.fixed_position'
        db.delete_column('frequently_entrycategory', 'fixed_position')
    ...
    models = {
        ...
        'frequently.entry': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 20, 0, 0)'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_view_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 20, 0, 0)'}),
        ...
        'frequently.feedback': {
            ...
            'submission_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 7, 20, 0, 0)'}),
